...
const About = () => {
   ...
   useEffect(() => {
      fetch(
         "https://api.github.com/repos/fajriyan/portfolio/commits?per_page=1",
      )
         .then((res) => res.json())
         .then((data) => {
               ...
               <div className="flex items-start">
                  ...
                  <div className="sm:ml-8">
                     ...
                     <p className="mt-1 text-sm text-gray-700 text-justify">
                        Fullstack Developer with approximately 3 years of
                        experience in web development, from monolith
                        architecture to microservices. Strong frontend
                        expertise, especially in building responsive, intuitive,
                        and user-friendly user interfaces with modern UX/UI
                        principles. Results-oriented and ambitious to deliver
                        the best output aligned with business objectives. Proven
                        ability to develop optimized web products through
                        industry-standard coding practices and effective SEO
                        strategies. Experienced in handling website development
                        and maintenance projects in startups, agencies, and
                        ...
                        <div className="transform transition ml-10 relative flex items-center px-6 py-4 rounded-xl border border-slate-400 text-slate-800 mb-5 flex-col md:flex-row md:space-y-0">
                           ...
                           <div className="flex-auto">
                              ...
                              <h3 className="text-sm">
                                 Informatics Engineering, Cumulative GPA
                                 3.61/4.00
                              </h3>
